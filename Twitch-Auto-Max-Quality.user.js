...
// @homepage https://github.com/Snake4life/Twitch-Auto-Max-Quality/
// @downloadURL https://raw.githubusercontent.com/Snake4life/Twitch-Auto-Max-Quality/master/Twitch-Auto-Max-Quality.user.js
// @updateURL   https://raw.githubusercontent.com/Snake4life/Twitch-Auto-Max-Quality/master/Twitch-Auto-Max-Quality.user.js
// @include     *://*.twitch.tv/*
...
// @grant       unsafeWindow
// ==/UserScript==
// @icon        https://raw.githubusercontent.com/Snake4life/Twitch-Auto-Max-Quality/master/images/logo.png
...
(async () => {
        ...
        var GM_setting = (function ($, global, document) { // 
            ...
            const settings_full = {
                ...
                max_quality_menu_trigger_prefer_1st : {
                    ...
                    type: "text",
                    value: "best",
                    title:"1st preferred quality for simulate settings button method",
                    desc:`(Choose one of the following: <strong>best</strong>, <strong>worst</strong>, 1080p, 720p, 720p60, 720p30, 480p, 360p, 160p, ...)`
                },
                max_quality_menu_trigger_prefer_2nd : {
                    ...
                    type: "text",
                    value: "720p",
                    title:"2nd preferred quality for simulate settings button method",
                    desc:`(Choose one of the following: 1080p, 720p, 720p60, 720p30, 480p, 360p, 160p, ...)`
                },
                ...
                max_quality_localstorage_prefer_1st : {
                    ...
                    type: "text",
                    value: "best",
                    title:"Video quality for localstorage modify method.",
                    desc:`(Choose one of the following: best(=chunked), 720p60, 720p30, 480p30, 360p30, 160p30)<br />If you enter an incorrect value or your preferred video quality is not supported, Twitch Player may choose "Auto".<br />Anything other than best(chunked) may not work. In this case, use the Simulate settings button method.`
                },
    ...
    GM.addStyle(`
        ...
        #GM_setting .GM_setting_depth3 .GM_setting_list_head{
            width:440px;
        }
    `);
